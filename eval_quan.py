...
def print_size_of_model(model):
    ...
    os.remove('temp.p')
model = Model()
model = torch.load("models/mnist0.977.pth")
...
print('accuracy: {:.6f}'.format(all_correct_num / all_sample_num), flush=True)
...
all_sample_num = 0
# print(1)
quantized_model = torch.load("models/mnist_quan0.977.pth")
# model = quanModel()
# device = 'cpu'
